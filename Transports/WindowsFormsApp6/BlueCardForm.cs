...
{
    public partial class BlueCardForm : Form
    {
        public BlueCardForm()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BlueCard card = new BlueCard(no, type, points);
            if (vehicle == "Bus")
            {
        ...
        private void BlueCardForm_Load(object sender, EventArgs e)
        {
            String cardType = "Blue Card";
            SqlConnection conn = new SqlConnection(@"Data source= DESKTOP-UO0RD8P\SQLEXPRESS ;Initial catalog= Transmission;Integrated Security=true");
            conn.Open();
